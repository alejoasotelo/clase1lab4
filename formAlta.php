...
<?php     
	...
	{
		$unaAlumno = Alumno::TraerUnaAlumno($_POST['dniParaModificar']);
		$titulo = "MODIFICACIÓN";
	} 
?>
	<div class="container">
		...
		<div class="CajaInicio animated bounceInRight">
			...
			<form id="FormIngreso" method="post" action="formAlta.php" enctype="multipart/form-data" >
				<input type="text" name="apellido" id="apellido" placeholder="ingrese apellido" value="<?php echo isset($unaAlumno) ?  $unaAlumno->GetApellido() : "" ; ?>" /><span id="lblApellido" style="display:none;color:#FF0000;width:1%;float:right;font-size:80">*</span>
				<input type="text" name="nombre" id="nombre" placeholder="ingrese nombre" value="<?php echo isset($unaAlumno) ?  $unaAlumno->GetNombre() : "" ; ?>" /> <span id="lblNombre" style="display:none;color:#FF0000;width:1%;float:right;font-size:80">*</span>
				<input type="text" name="dni" id="dni" placeholder="ingrese dni" value="<?php echo isset($unaAlumno) ?  $unaAlumno->GetDni() : "" ; ?>" <?php echo isset($unaAlumno) ?  "readonly": "" ; ?>        /> <span id="lblDni" style="display:none;color:#FF0000;width:1%;float:right;font-size:80">*</span>
				<?php echo isset($unaAlumno) ? 	"<p style='color: black;'>*El DNI no se puede modificar.</p> ": "" ; ?>
				<input type="hidden" name="idOculto" value="<?php echo isset($unaAlumno) ? $unaAlumno->GetId() : "" ; ?>" />
				<input type="file" name="foto" />


				<img  src="fotos/<?php echo isset($unaAlumno) ? $unaAlumno->GetFoto() : "pordefecto.png" ; ?>" class="fotoform"/>
